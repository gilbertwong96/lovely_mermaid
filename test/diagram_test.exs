defmodule LovelyMermaid.DiagramTest do
  ...
  describe "pie" do
    ...
    test "nil when no slices parse" do
      assert LovelyMermaid.render("pie\n  garbage\n") == nil
      assert LovelyMermaid.render("flowchart TD\n  A --> B\n") != nil
    end
  end
  ...
  describe "mindmap" do
    ...
    test "decoration lines are skipped" do
      art = LovelyMermaid.render("mindmap\n  root\n    :::icon\n    child\n")
    ...
    test "nil when no nodes" do
      assert LovelyMermaid.render("mindmap\n  \n") == nil
    end
  end
  ...
  describe "timeline" do
    ...
    test "a bare period renders event-less" do
      art = LovelyMermaid.render("timeline\n  2020\n")
    ...
    test "nil when no rows" do
      assert LovelyMermaid.render("timeline\n") == nil
    end
  end
  ...
  describe "gitgraph" do
    ...
    test "unnamed commits get auto ids" do
      art = LovelyMermaid.render("gitGraph\n  commit\n  commit\n")
    ...
    test "nil when no commits" do
      assert LovelyMermaid.render("gitGraph\n") == nil
    end
  end

  describe "diagram_kind" do
    test "reports the new kinds" do
      assert LovelyMermaid.diagram_kind("pie title x\n") == :pie
      assert LovelyMermaid.diagram_kind("mindmap\n  root\n") == :mindmap
      assert LovelyMermaid.diagram_kind("timeline\n  a : b\n") == :timeline
      assert LovelyMermaid.diagram_kind("gitGraph LR:\n  commit\n") == :gitgraph
    end
  end
end
