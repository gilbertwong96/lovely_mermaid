defmodule LovelyMermaid.Art do
  @moduledoc """
  What `LovelyMermaid.render/1` (and `LovelyMermaid.SourceBox.source_box/2`)
  ...
  split into `LovelyMermaid.Span` runs for theming; `width` is the column
